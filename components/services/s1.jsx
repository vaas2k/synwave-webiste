...
const S1 = () => {
  ...
  return (
    <div className="relative h-[30rem] sm:h-[25rem] flex justify-center items-center px-4 flex-col mt-[95px]">
      ...
      {/* Text content */}
      <div className="text-4xl mx-auto text-neutral-600 dark:text-white pb-[30px] relative z-10">
        Build
